...
CreeperAura = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
	["Name"] = "CreeperAura", 
	["Function"] = function(callback)
		if callback then
			BindToRenderStep("CreeperAura", 1, function() 
...
killauraangle = CreeperAura.CreateSlider({
	["Name"] = "Angle",
	["Min"] = 1,
	["Max"] = 180, 
	["Function"] = function(val) end,
...
killauramouse = CreeperAura.CreateToggle({
	["Name"] = "CreeperAura", 
	["Function"] = function() end
})
killauracframe = CreeperAura.CreateToggle({
	["Name"] = "Face target", 
	["Function"] = function() end
})