...
--Credits to Danm#0001 for making most the modules!
--Join the discord if you havent already https://discord.gg/SnoopyConfigs
...
createwarning("Snoopy Private", "Snoopy loaded :)", 5)
...
local fakeplr = {["Name"] = "SnoopyPriv Name Hider", ["UserId"] = "1"}
local otherfakeplayers = {["Name"] = "SnoopyPriv Name Hider", ["UserId"] = "1"}
local lplr = game:GetService("Players").LocalPlayer
