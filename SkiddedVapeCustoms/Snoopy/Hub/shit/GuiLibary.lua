...
local array = loadstring(game:HttpGet("https://raw.githubusercontent.com/std-cin/Bedwars-Archives/main/SkiddedVapeCustoms/Snoopy/Hub/shit/ArrayList.lua"))()
local commands = loadstring(game:HttpGet("https://raw.githubusercontent.com/std-cin/Bedwars-Archives/main/SkiddedVapeCustoms/Snoopy/Hub/shit/Commands.lua", true))()
local lib = {
    ["Rainbow"] = false,
    ["Notifications"] = false,
    ["Sounds"] = true,
