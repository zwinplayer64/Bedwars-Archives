-- Azura Private Developing by scepty#2087 --
...
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Text = "AzuraPrivate"
GuiLibrary["MainGui"].ScaledGui.ClickGui.MainWindow.TextLabel.Text = "AzuraPrivate"
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Version.Text = "AzuraPrivate"
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Position = UDim2.new(1, -175 - 20, 1, -25)
infonotify("AzuraPrivate", "Loaded", 5)
...
local playerlist = game:GetService("CoreGui"):FindFirstChild("PlayerList")
    ...
    COB("Utility", {
        ...
        HoverText = "for keybind only, idk why i maked this"
    })
...
function notify(text)
    local frame = GuiLibrary["CreateNotification"]("Azura", text, 5, "assets/WarningNotification.png")
    frame.Frame.Frame.ImageColor3 = Color3.fromRGB(255, 64, 64)
end
function boxnotify(text)
    if messagebox then
