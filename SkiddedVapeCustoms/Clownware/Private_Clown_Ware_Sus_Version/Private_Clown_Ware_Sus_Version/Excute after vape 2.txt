...
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Text = "AutoWin Clownware v69 private"
GuiLibrary["MainGui"].ScaledGui.ClickGui.MainWindow.TextLabel.Text = "AutoWin Clownware v69 private"
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Version.Text = "AutoWin Clownware v69 private"
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Position = UDim2.new(1, -175 - 20, 1, -25)
infonotify("AutoWin Clownware v69 private", "Loaded successfully!", 5)




local AnticheatDisabler = COB("World", {
	Name = "AutoWin Clownware v69 private",
...
local AnticheatDisabler = LIB("World", {
