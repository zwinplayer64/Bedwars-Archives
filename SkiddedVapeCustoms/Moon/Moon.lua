...
runcode(function()
	...
	local anims = {
		...
		SlowZylaAnim = {
			{CFrame = CFrame.new(0, 0, 0) * CFrame.Angles(-math.rad(190), math.rad(110), -math.rad(90)), Time = 0.6},
			{CFrame = CFrame.new(0.3, -2, 2) * CFrame.Angles(math.rad(120), math.rad(140), math.rad(320)), Time = 0.6}
		}
	}
  ...
  --[[  killauratargets = Killaura.CreateSlider({
    ...
    killauraanimmethod = Killaura.CreateDropdown({
        ["Name"] = "Animation", 
        ["List"] = {"Normal", "Slow", "New", "Vertical Spin", "Exhibition", "Exhibition Old", "OldAstralAnim", "SlowOldAstralAnim", "ZylaAnim", "SliceAnim", "SlowSliceAnim", "DamcAnim", "DamcAnim2", "DamcAnim3", "Swiss", "SlowSwiss", "SlowZylaAnim"},
        ["Function"] = function(val) end
    })
...
local FunnyHighJump = {["Enabled"] = false}
	FunnyHighJump = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
        ["Name"] = "FunnyHighJump",
        ["HoverText"] = "module made by @Spring67#6969 <3",
            ["Function"] = function(callback)
                if callback then
					if FastHighJump["Enabled"] then
					...
					elseif MidHighJump["Enabled"] then
						local Velocity = Instance.new("BodyVelocity",game.Players.LocalPlayer.Character.HumanoidRootPart)
						Velocity.Name = "Velocity1"
						game.Workspace.Gravity = 0
						Velocity.Velocity = Vector3.new(0,350,0)
					elseif SlowHighJump["Enabled"] then
					local Velocity = Instance.new("BodyVelocity",game.Players.LocalPlayer.Character.HumanoidRootPart)
					Velocity.Name = "Velocity1"
					game.Workspace.Gravity = 0
				...
				game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity2:Destroy()
            end
        end
    })
	FastHighJump = FunnyHighJump.CreateToggle({
		["Name"] = "FastHighJump",
		["Function"] = function() end, 
		["Default"] = true
	})
	MidHighJump = FunnyHighJump.CreateToggle({
		["Name"] = "MidHighJump",
		["Function"] = function() end, 
		["Default"] = false
	})
	SlowHighJump = FunnyHighJump.CreateToggle({
		["Name"] = "SlowHighJump",
		["Function"] = function() end, 
		["Default"] = false
	})
...
local GravFly = {["Enabled"] = false}
	GravFly = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
        ["Name"] = "GravityFly",
		["HoverText"] = "Using speedpot == faster and longer fly lol",
            ["Function"] = function(callback)
                if callback then
					if GravFlyJump["Enabled"] then
						game.Players.LocalPlayer.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
						wait()
						game.Workspace.Gravity = 0
					elseif GravFlyTp["Enabled"] then
						game.Workspace.Gravity = 0
						_G.GravFlyTp = true
						while _G.GravFlyTp do wait()
							lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 0.15
						end
					elseif DamageGravFly["Enabled"] then
						game.Workspace.Gravity = 0
						_G.DamageGravFly = true
						while _G.DamageGravFly do wait()
					...
					elseif LowTpUp["Enabled"] then
						game.Workspace.Gravity = 0
						_G.LowTpUp = true
						while _G.LowTpUp do wait()
							lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame * CFrame.new(0, 0.6, 0)
						end
					elseif HighTpUp["Enabled"] then
						game.Workspace.Gravity = 0
						_G.HighTpUp = true
						while _G.HighTpUp do wait()
							lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0)
						end
					else
						game.Workspace.Gravity = 0
					end
	...
	GravFlyJump = GravFly.CreateToggle({
		["Name"] = "GravFlyJump",
		["Function"] = function() end, 
		["Default"] = true
	})
	GravFlyTp = GravFly.CreateToggle({
		["Name"] = "GravFlyTp",
		["Function"] = function() end, 
		["Default"] = false
	})
	DamageGravFly = GravFly.CreateToggle({
		["Name"] = "DamageGravFly",
		["HoverText"] = "Take damage before used",
		["Function"] = function() end, 
		["Default"] = false
	})
	LowTpUp = GravFly.CreateToggle({
		["Name"] = "LowTpUp",
		["Function"] = function() end, 
		["Default"] = false
	})
	HighTpUp = GravFly.CreateToggle({
		["Name"] = "HighTpUp",
		["Function"] = function() end, 
		["Default"] = false
	})
...
local Night = {["Enabled"] = false}
	Night = GuiLibrary["ObjectsThatCanBeSaved"]["WorldWindow"]["Api"].CreateOptionsButton({
    	["Name"] = "Night",
    	["HoverText"] = "module fixed by @Spring67 <3",
    	["Function"] = function(callback)
        	if callback then
...
local BetterLongJump = {["Enabled"] = false}
	BetterLongJump = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
    	["Name"] = "BetterLongJump",
    	["HoverText"] = "module made by @Spring67 <3",
    	["Function"] = function(callback)
        	if callback then
				if LongJumpBypass1["Enabled"] then
					...
					createwarning("Moon", "Is now using CFrame (15)", 5)
					for i=1,15 do
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 0.8
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame * CFrame.new(0, 1, 0)
						wait()
					end
					BetterLongJump["ToggleButton"](false)
				elseif LongJumpBypass2["Enabled"] then
					game.Workspace.Gravity = 1
					game.Players.LocalPlayer.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
				elseif LongJumpBypass3["Enabled"] then
					lplr.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
					wait(0.48)
					lplr.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
					wait(0.48)
					...
					lplr.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
					BetterLongJump["ToggleButton"](false)
				elseif LongJumpBypass4["Enabled"] then
					_G.LongJumpBypass4 = true
					while _G.LongJumpBypass4 do wait()
						lplr.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
					end
					elseif LongJumpBypass5["Enabled"] then
						game.Workspace.Gravity = 1
						for i=1,5 do
							lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame * CFrame.new(0, 1.25, 0)
							wait()
						end
						for i=1,5 do
							...
							wait()
							lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 0.3
						end
						wait(1.75)
						BetterLongJump["ToggleButton"](false)
					else
					createwarning("Moon", "No options chosen.", 2.5)
					wait()
					BetterLongJump["ToggleButton"](false)
				end
        	else
				_G.LongJumpBypass4 = false
				game.Workspace.Gravity = 192.6
				if speed["ToggleButton"](true) then
				else
	...
	LongJumpBypass1 = BetterLongJump.CreateToggle({
		["Name"] = "TeleportV1",
		["Function"] = function() end, 
		["Default"] = false
	})
	LongJumpBypass2 = BetterLongJump.CreateToggle({
		["Name"] = "Gravity1",
		["Function"] = function() end, 
		["Default"] = false
	})
	LongJumpBypass3 = BetterLongJump.CreateToggle({
		["Name"] = "LongWaitJump",
		["Function"] = function() end, 
		["Default"] = false
	})
	LongJumpBypass4 = BetterLongJump.CreateToggle({
		["Name"] = "SpamJump",
		["Function"] = function() end, 
		["Default"] = false
	})
	LongJumpBypass5 = BetterLongJump.CreateToggle({
		["Name"] = "TeleportV2",
		["HoverText"] = "Barely flags LOL",
		["Function"] = function() end, 
		["Default"] = true
	})

local BetterFly = {["Enabled"] = false}
	BetterFly = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
    	["Name"] = "BetterFly",
    	["HoverText"] = "module made by @Spring67 <3",
    	["Function"] = function(callback)
        	if callback then
				if FlyBypass1["Enabled"] then
					speed["ToggleButton"](false)
					lplr.Character.Humanoid.WalkSpeed = 0
					game.Workspace.Gravity = 0
					lplr.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
					createwarning("Moon", "Is now using CFrame (4) for 'BetterFly'", 5)
					for i=1,4 do wait(0.44)
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 12
					end
					lplr.Character.Humanoid.WalkSpeed = 16
					BetterFly["ToggleButton"](false)
				elseif FlyBypass2["Enabled"] then
					game.Workspace.Gravity = 0
					speed["ToggleButton"](false)
					for i=1,3 do wait()
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 1
					end
					for i=1,4 do wait()
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 0.75
					end
					for i=1,5 do wait()
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 0.5
					end
					for i=1,6 do wait()
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 0.25
					end
					wait(0.5)
					for i=1,6 do wait()
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 0.75
					end
				elseif FlyBypass3["Enabled"] then
					speed["ToggleButton"](false)
					lplr.Character.Humanoid.WalkSpeed = 0
					game.Workspace.Gravity = 0
					for i=1,2 do wait(0.6)
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame * CFrame.new(0, 1, 0)
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 11
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame * CFrame.new(0, 1, 0)
						wait(0.4)
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame * CFrame.new(0, -1, 0)
						lplr.Character.HumanoidRootPart.CFrame = lplr.Character.HumanoidRootPart.CFrame + lplr.Character.HumanoidRootPart.CFrame.lookVector * 11
					...
					BetterFly["ToggleButton"](false)
					lplr.Character.Humanoid.WalkSpeed = 16
				elseif FlyBypass4["Enabled"] then
					print("HI")
				else
					createwarning("Moon", "No options chosen.", 2.5)
					BetterFly["ToggleButton"](false)
	...
	FlyBypass1 = BetterFly.CreateToggle({
		["Name"] = "CubecraftFly",
		["Function"] = function() end, 
		["Default"] = false
	})
	FlyBypass2 = BetterFly.CreateToggle({
		["Name"] = "HypixelFly",
		["Function"] = function() end, 
		["Default"] = true
	})
	FlyBypass3 = BetterFly.CreateToggle({
		["Name"] = "RedeskyFly1",
		["Function"] = function() end, 
		["Default"] = false
	})
	FlyBypass4 = BetterFly.CreateToggle({
		["Name"] = "BetterFlyyy",
		["Function"] = function() end, 
		["Default"] = false
	})